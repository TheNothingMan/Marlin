 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100.4 } //100.4 for E instead of 92.6
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the boundaries for probing (where the probe can reach).CHECK
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 170, 10, (Z_MIN_POS + 1)}
  #define NOZZLE_CLEAN_END_POINT   {200, 40, (Z_MIN_POS + 1)}
...
#define SERVO_DELAY { 1000,300,300 }
